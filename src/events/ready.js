module.exports = async(client) => {
    ...
    for (const guild of leftGuilds) {
        ...
        client.logger.info(`Ironman has left ${guild.guild_name}`);
    }

    client.logger.info('Ironman is now online');
    client.logger.info(`Ironman is running on ${client.guilds.cache.size} server(s)`);
};